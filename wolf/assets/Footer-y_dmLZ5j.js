import{r as n,j as t,a as w}from"./index-SUo8xEJ1.js";import{T as A,E as k,t as F,h as I}from"./ResetPasswordDailog-S5QLUaSV.js";import{ab as p,K as f,ac as S,U as B,C as O}from"./App-iG37fEVl.js";function y(e){return p({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 000 2h6a1 1 0 100-2H7z",clipRule:"evenodd"}}]})(e)}function T(e){return p({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z",clipRule:"evenodd"}}]})(e)}function M({markets:e}){const[l,a]=n.useState([]);return n.useEffect(()=>{a(e.map(i=>!1))},[e]),t.jsx(t.Fragment,{children:e.map((i,s)=>t.jsxs(w.Fragment,{children:[t.jsxs("p",{className:"iconForCollapse",onClick:()=>{a(d=>[...d].map((r,v)=>v!==s?!1:!r))},children:[l[s]?t.jsx(y,{className:"iconForCollapse"}):t.jsx(T,{className:"iconForCollapse"}),i.name]}),t.jsx(f,{in:l[s],unmountOnExit:!0,children:t.jsx("div",{className:"rulesDiv",dangerouslySetInnerHTML:{__html:i.rule}})})]},i.name+s))})}const c=[{name:"Football",rules:[{name:"bookmaker",rule:`<div data-parent="#eventaccordion0" id="event0game0" class="card-body collapse show" style=""><div class="rule-text">
