import{r as n,j as t,a as p}from"./index-DonKxy3F.js";import{T as k,E as F,t as S,h as I}from"./ResetPasswordDailog-DWX6LWv_.js";import{aa as f,L as y,ab as B,U as O,D as j}from"./App-C5ZVebJP.js";import{L as M,_ as W}from"./index-B3omxtVj.js";function T(e){return f({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 000 2h6a1 1 0 100-2H7z",clipRule:"evenodd"}}]})(e)}function A(e){return f({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z",clipRule:"evenodd"}}]})(e)}function N({markets:e}){const[l,a]=n.useState([]);return n.useEffect(()=>{a(e.map(i=>!1))},[e]),t.jsx(t.Fragment,{children:e.map((i,s)=>t.jsxs(p.Fragment,{children:[t.jsxs("p",{className:"iconForCollapse",onClick:()=>{a(d=>[...d].map((r,v)=>v!==s?!1:!r))},children:[l[s]?t.jsx(T,{className:"iconForCollapse"}):t.jsx(A,{className:"iconForCollapse"}),i.name]}),t.jsx(y,{in:l[s],unmountOnExit:!0,children:t.jsx("div",{className:"rulesDiv",dangerouslySetInnerHTML:{__html:i.rule}})})]},i.name+s))})}const c=[{name:"Football",rules:[{name:"bookmaker",rule:`<div data-parent="#eventaccordion0" id="event0game0" class="card-body collapse show" style=""><div class="rule-text">
                                                    ...
                                                    </div></div>`},{name:"fancy",rule:`<div data-parent="#eventaccordion0" id="event0game1" class="card-body collapse show" style=""><div class="rule-text text-danger">
                                                    ...
                                                    </div></div>`},{name:"match",rule:`<div data-parent="#eventaccordion0" id="event0game2" class="card-body collapse show" style=""><div class="rule-text">
                                                        Match Odds :-  
...
Bets will be void if the match is abandoned. Extra-time and penalty shootouts do not count.
                                                    </div></div>`}]},{name:"Cricket",rules:[{name:"bookmaker",rule:`<div data-parent="#eventaccordion8" id="event8game0" class="card-body collapse show" style=""><div class="rule-text text-danger">
                                                    ...
                                                    </div></div>`},{name:"fancy",rule:`<div data-parent="#eventaccordion8" id="event8game1" class="card-body collapse show" style=""><div class="rule-text">
                                                    ...
                                                    </div></div>`},{name:"fancy1",rule:`<div data-parent="#eventaccordion8" id="event8game3" class="card-body collapse show" style=""><div class="rule-text text-danger">
                                                    ...
                                                    </div></div>`},{name:"match",rule:`<div data-parent="#eventaccordion8" id="event8game5" class="card-body collapse show" style=""><div class="rule-text text-danger">
                                                        IPL
                                                    </div><div class="rule-text text-danger">
                                                    ...
                                                    </div></div>`}]},{name:"Tennis",rules:[{name:"match",rule:`<div data-parent="#eventaccordion6" id="event6game0" class="card-body collapse show" style=""><div class="rule-text">
                                                        Match Odds :- 
...
I get my stake back if I placed a bet on O/U 10.5 (it is undecided, the set could have ended 6-4).
                                                    </div></div>`}]}],R=()=>{const[e,l]=n.useState([]);return n.useEffect(()=>{l(c.map(a=>!1))},[c]),t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"britishdiv",children:[t.jsx("img",{className:"britishimg",src:"/assets/images/british.png",alt:""}),t.jsx(k,{color:"white",fontSize:"15px",children:"English"}),t.jsx(B,{size:"13px"})]}),c.map((a,i)=>t.jsxs(p.Fragment,{children:[t.jsxs("p",{className:"iconForCollapse",onClick:()=>{l(s=>[...s].map((o,r)=>r!==i?!1:!o))},style:{cursor:"pointer"},children:[e[i]?t.jsx(T,{className:"iconForCollapse"}):t.jsx(A,{className:"iconForCollapse"}),a.name]}),t.jsx(y,{unmountOnExit:!0,in:e[i],children:t.jsx("div",{className:"rulesMarketDiv",children:t.jsx(N,{markets:a.rules})})})]},a.name+i))]})},L=()=>{var s,d,o,r,v,u,h,g,m,b,x,w;const{footerData:e}=n.useContext(O),[l,a]=n.useState(!1),i=window.location.hostname;return t.jsxs("div",{children:[t.jsxs(F,{title:"Rules",maxWidth:"md",open:l,handleClose:()=>a(!1),children:[t.jsx(R,{}),t.jsx(S,{children:t.jsx(j,{className:"modal-footer-rules",children:t.jsx(I,{onClick:()=>a(!1),variant:"contained",color:"error",children:"Close"})})})]}),t.jsxs("footer",{className:"footer",children:[t.jsxs("div",{className:"support",children:[t.jsxs("div",{children:[t.jsx("div",{className:"w-100 text-center",children:t.jsx("b",{children:e==null?void 0:e.support})}),t.jsx("div",{className:"text-center w-100",children:t.jsx("span",{className:"phones",children:e==null?void 0:e.mobileNo})})]}),t.jsxs("div",{className:"footer-social",children:[(e==null?void 0:e.s_whatsapp)&&t.jsx("a",{href:(s=e==null?void 0:e.s_whatsapp)==null?void 0:s.link,target:"_blank",rel:"noreferrer",children:t.jsx("img",{alt:"",src:(d=e==null?void 0:e.s_whatsapp)==null?void 0:d.icon})}),(e==null?void 0:e.s_facebook)&&t.jsx("a",{href:(o=e==null?void 0:e.s_facebook)==null?void 0:o.link,target:"_blank",rel:"noreferrer",children:t.jsx("img",{alt:"",src:(r=e==null?void 0:e.s_facebook)==null?void 0:r.icon})}),(e==null?void 0:e.s_instagram)&&t.jsx("a",{href:(v=e==null?void 0:e.s_instagram)==null?void 0:v.link,target:"_blank",rel:"noreferrer",children:t.jsx("img",{alt:"",src:(u=e==null?void 0:e.s_instagram)==null?void 0:u.icon})}),(e==null?void 0:e.s_telegram)&&t.jsx("a",{href:(h=e==null?void 0:e.s_telegram)==null?void 0:h.link,target:"_blank",rel:"noreferrer",children:t.jsx("img",{alt:"",src:(g=e==null?void 0:e.s_telegram)==null?void 0:g.icon})}),(e==null?void 0:e.s_twitter)&&t.jsx("a",{href:(m=e==null?void 0:e.s_twitter)==null?void 0:m.link,target:"_blank",rel:"noreferrer",children:t.jsx("img",{alt:"",src:(b=e==null?void 0:e.s_twitter)==null?void 0:b.icon})}),(e==null?void 0:e.s_youtube)&&t.jsx("a",{href:(x=e==null?void 0:e.s_youtube)==null?void 0:x.link,target:"_blank",rel:"noreferrer",children:t.jsx("img",{alt:"",src:(w=e==null?void 0:e.s_youtube)==null?void 0:w.icon})})]})]}),(i==null?void 0:i.includes("onlycricket.co.in"))&&t.jsx(M,{isSignedIn:!0,children:t.jsxs(W,{gradient:!1,speed:50,style:{overflow:"hidden",color:"white",fontSize:"0.8rem",padding:"12px"},children:["For id Deposit Withdrawal and Support What'sApp"," "," ",t.jsxs("b",{style:{marginLeft:"2px",marginRight:"12px"},children:[" "," 7509039999"]})]})}),t.jsx("div",{className:"footer-menu",children:t.jsxs("ul",{children:[t.jsx("li",{children:t.jsx("a",{href:"/about-us",className:"",target:"_blank",rel:"noreferrer",children:"About Us"})})," ",t.jsx("li",{children:t.jsx("a",{href:"#",className:"",onClick:()=>a(!0),rel:"noreferrer",children:"Rules"})}),t.jsx("li",{children:t.jsx("a",{href:"/terms-and-conditions",className:"",target:"_blank",rel:"noreferrer",children:"Terms and Conditions"})}),t.jsx("li",{children:t.jsx("a",{href:"/responsible-gaming",className:"",target:"_blank",rel:"noreferrer",children:"Responsible Gaming"})})]})}),t.jsxs("div",{className:"footer-box",children:[t.jsxs("div",{className:"footer-top",children:[t.jsxs("div",{className:"secure-logo",children:[t.jsx("div",{children:t.jsx("img",{src:"https://sitethemedata.com/v89/static/front/img/ssl.png",alt:""})})," ",t.jsxs("div",{className:"ml-2",children:[t.jsx("b",{children:"100% SAFE"})," ",t.jsx("div",{children:"Protected connection and encrypted data."})]})]}),t.jsxs("div",{className:"d-inline-block footer-other",children:[t.jsx("a",{href:"/",role:"button",children:t.jsx("img",{src:"https://sitethemedata.com/v89/static/front/img/18plus.png",alt:""})})," ",t.jsx("a",{href:" /",target:"_blank",rel:"noreferrer",children:t.jsx("img",{src:"https://sitethemedata.com/v89/static/front/img/gamecare.png",alt:""})})," ",t.jsx("a",{href:" /",target:"_blank",rel:"noreferrer",children:t.jsx("img",{src:"https://sitethemedata.com/v89/static/front/img/gt.png",alt:""})}),t.jsx("a",{href:"/",className:"vm badge-icon",children:t.jsx("div",{id:"apg-750c6d2a-0352-4b88-aaa7-72085659af51","data-apg-seal-id":"750c6d2a-0352-4b88-aaa7-72085659af51","data-apg-image-size":"45","data-apg-image-type":"basic-light-large",className:"d-inline-block vm"})})]})]})," ",t.jsx("div",{className:"payments",children:t.jsxs("ul",{children:[(e==null?void 0:e.u_googlePay)&&t.jsx("li",{children:t.jsx("img",{src:e==null?void 0:e.u_googlePay,alt:"effect",className:"img-fluid"})}),(e==null?void 0:e.u_paytm)&&t.jsx("li",{children:t.jsx("img",{src:e==null?void 0:e.u_paytm,alt:"effect",className:"img-fluid"})}),(e==null?void 0:e.u_phonePe)&&t.jsx("li",{children:t.jsx("img",{src:e==null?void 0:e.u_phonePe,alt:"effect",className:"img-fluid"})}),(e==null?void 0:e.u_upi)&&t.jsx("li",{children:t.jsx("img",{src:e==null?void 0:e.u_upi,alt:"effect",className:"img-fluid"})})]})})," ",t.jsx("div",{className:"footer-bottom",children:t.jsxs("span",{className:"ws-pre-wrap",children:[window.location.hostname.replace("www.",""),"."]})})]}),t.jsx("div",{className:"w-100 copyright",children:"Copyright 2020. All Rights Reserved."})]})]})};export{L as F};
