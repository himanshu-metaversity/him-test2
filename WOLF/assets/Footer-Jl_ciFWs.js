import{r as n,j as t,a as p}from"./index-14ZlkfOM.js";import{T as k,E as F,t as S,h as I}from"./ResetPasswordDailog-BUEV2ABV.js";import{L as f,N as B,O,_ as j}from"./index-BgehC26x.js";import{K as y,U as M,D as N}from"./App-CxIrtsvz.js";function T(e){return f({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 000 2h6a1 1 0 100-2H7z",clipRule:"evenodd"}}]})(e)}function A(e){return f({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z",clipRule:"evenodd"}}]})(e)}function W({markets:e}){const[l,a]=n.useState([]);return n.useEffect(()=>{a(e.map(i=>!1))},[e]),t.jsx(t.Fragment,{children:e.map((i,s)=>t.jsxs(p.Fragment,{children:[t.jsxs("p",{className:"iconForCollapse",onClick:()=>{a(d=>[...d].map((r,v)=>v!==s?!1:!r))},children:[l[s]?t.jsx(T,{className:"iconForCollapse"}):t.jsx(A,{className:"iconForCollapse"}),i.name]}),t.jsx(y,{in:l[s],unmountOnExit:!0,children:t.jsx("div",{className:"rulesDiv",dangerouslySetInnerHTML:{__html:i.rule}})})]},i.name+s))})}const c=[{name:"Football",rules:[{name:"bookmaker",rule:`<div data-parent="#eventaccordion0" id="event0game0" class="card-body collapse show" style=""><div class="rule-text">
